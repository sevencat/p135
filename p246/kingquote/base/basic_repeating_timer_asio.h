...
namespace asio
{
    ...
    template <typename Time,
              ...
              typename TimerService = asio::deadline_timer_service<Time, TimeTraits> >
    class basic_repeating_timer : public asio::basic_io_object<TimerService>
    {
    public:
        typedef asio::basic_deadline_timer<Time>  timer_type;

        explicit basic_repeating_timer( asio::io_service& io_service )
    ...
    private:
        ...
        public:
            ...
            virtual void handler( asio::error_code const & ) = 0;
        };
        ...
        public:
            ...
            virtual void handler( asio::error_code const & result )
            {
        ...
        {
        public:
            static internal_timer_ptr create( asio::io_service& io_service,
        ...
        private:
            ...
            internal_timer( asio::io_service& io_service )
                :timer_(io_service)
            {
            }
                        ...
                        boost::shared_ptr<handler_base> const & handler )
            {
                ...
                timer_.async_wait( boost::bind( &internal_timer::handle_timeout, this->shared_from_this(), asio::placeholders::error ) );
            }

            void handle_timeout(asio::error_code const& error)
            {
